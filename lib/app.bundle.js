...
var startTracking = function startTracking(_ref) {
...
/* harmony default export */ __webpack_exports__["default"] = (startTracking);

/***/ }),

/***/ "./src/gps/gps-averaging.js":
/*!**********************************!*\
  !*** ./src/gps/gps-averaging.js ***!
  \**********************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var MAX_SECONDS_THRESHOLD = 10;

var gpsAveraging = function gpsAveraging(_ref) {
  var onCalculated = _ref.onCalculated;
  var locationEntries = [];

  var __findAveragePosition = function __findAveragePosition() {
    var now = parseInt(+new Date() / 1000, 10);
    locationEntries = locationEntries.filter(function (_ref2) {
      var time = _ref2.time;
      return Boolean(now - MAX_SECONDS_THRESHOLD < time);
    });

    if (locationEntries.length > 0) {
      var sumLat = 0;
      var sumLng = 0;
      locationEntries.forEach(function (_ref3) {
        var lat = _ref3.lat,
            lng = _ref3.lng;
        sumLat = sumLat + lat;
        sumLng = sumLng + lng;
  ...
  var __feed = function __feed(_ref4) {
    var lat = _ref4.lat,
        lng = _ref4.lng;
    console.log('Feed', {
      lat: lat,
...
/* harmony default export */ __webpack_exports__["default"] = (gpsAveraging);
...
/* harmony import */ var core_js_modules_es6_regexp_constructor__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! core-js/modules/es6.regexp.constructor */ "./node_modules/core-js/modules/es6.regexp.constructor.js");
...
/* harmony import */ var _hm_10__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./hm-10 */ "./src/gps/hm-10.js");
...
var positioningReg = new RegExp(/LA([0-9]{2}.[0-9]*)LO([0-9]{2}.[0-9]+)\|/gm);
var updateViewInterval = null;
var lastFix = null;

var updateView = function updateView(_ref) {
  var domContainer = _ref.domContainer;
  var currentTime = parseInt(Date.now() / 1000, 10);
  var fixTime = lastFix ? "".concat(Number(currentTime - lastFix), " seconds ago") : 'no fix';
  domContainer.innerHTML = ["<p>BLE Last Fix: ".concat(fixTime)].join('');
};

/* harmony default export */ __webpack_exports__["default"] = (function (_ref2) {
  var domContainer = _ref2.domContainer,
      onPosition = _ref2.onPosition;
  var buffer = '';
  updateViewInterval = setInterval(function () {
    updateView({
      domContainer: domContainer
    });
  }, 1000);
  Object(_hm_10__WEBPACK_IMPORTED_MODULE_12__["default"])({
    onReading: function onReading(str) {
      buffer = buffer + str;
      buffer = buffer.split(' ').join('');
      var matches = buffer.match(positioningReg);

      if (matches && matches.length > 0) {
        buffer = '';
        matches.forEach(function (positionStr) {
          var _positioningReg$exec = positioningReg.exec(positionStr),
              _positioningReg$exec2 = _slicedToArray(_positioningReg$exec, 3),
              whole = _positioningReg$exec2[0],
              lat = _positioningReg$exec2[1],
              lng = _positioningReg$exec2[2];

          if (lat && lng) {
            lastFix = parseInt(Date.now() / 1000, 10); // bug with NMEA parser on the device
...
/* harmony import */ var _gps__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./gps */ "./src/gps/index.js");
/* harmony import */ var _gps_device__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./gps/device */ "./src/gps/device.js");
/* harmony import */ var _gps_gps_averaging__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./gps/gps-averaging */ "./src/gps/gps-averaging.js");
/* harmony import */ var _map__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./map */ "./src/map/index.js");
...
window.onload = function () {
  ...
  var prognosisMarker = null;
  var deviceAccuracyCircle = null;
  var mapSelect = document.getElementById('map-select');
  var loadButton = document.getElementById('load-button');
  var bleButton = document.getElementById('ble-start-button');
  ["park","pl.journalist"].forEach(function (mapName) {
  ...
  var _gpsAveraging = Object(_gps_gps_averaging__WEBPACK_IMPORTED_MODULE_9__["default"])({
    onCalculated: function onCalculated(_ref) {
      var lat = _ref.lat,
          lng = _ref.lng;
      ...
      if (!prognosisMarker) {
        prognosisMarker = new google.maps.Marker({
          map: map,
          icon: _objectSpread(_objectSpread({}, _map__WEBPACK_IMPORTED_MODULE_10__["arrowIcon"]), {}, {
            fillColor: '#ff0000'
          })
        });
      }

      prognosisMarker.setPosition({
        lat: lat,
        lng: lng
      });
    }
  }),
      feed = _gpsAveraging.feed;

  loadButton.onclick = function () {
    var mapPath = "/maps/".concat(mapSelect.value);
    fetch("".concat(mapPath, "/metadata.json")).then(function (response) {
      return response.json();
    }).then(function (data) {
      document.getElementById('map').innerHTML = '';
      map = Object(_map__WEBPACK_IMPORTED_MODULE_10__["default"])({
  ...
  bleButton.onclick = function () {
    Object(_gps__WEBPACK_IMPORTED_MODULE_7__["default"])({
      domContainer: document.getElementById('gps'),
      onPosition: function onPosition(_ref2) {
        var lat = _ref2.lat,
            lng = _ref2.lng;
        feed({
          lat: lat,
        ...
        if (!bleMarker) {
          bleMarker = new google.maps.Marker({
            map: map,
            icon: _objectSpread(_objectSpread({}, _map__WEBPACK_IMPORTED_MODULE_10__["arrowIcon"]), {}, {
              fillColor: '#3944bc'
            })
  ...
  Object(_gps_device__WEBPACK_IMPORTED_MODULE_8__["default"])({
    onSuccess: function onSuccess(_ref3) {
      var _ref3$coords = _ref3.coords,
          lat = _ref3$coords.latitude,
          lng = _ref3$coords.longitude,
          acc = _ref3$coords.accuracy;
      feed({
        lat: lat,
        lng: lng
      });
      ...
      if (!deviceMarker) {
        deviceMarker = new google.maps.Marker({
          map: map,
          icon: _map__WEBPACK_IMPORTED_MODULE_10__["arrowIcon"]
        });
      }
      ...
      deviceAccuracyCircle.setCenter({
        lat: lat,
        lng: lng
      });
    ...
    onError: function onError(err) {
      return alert("Error: ".concat(err.code || err.message));
    }
  });
};
...
/*!**************************!*\
  !*** ./src/map/index.js ***!
  \**************************/
/*! exports provided: arrowIcon, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  ...
  var map;
  var mapBounds = new google.maps.LatLngBounds(new google.maps.LatLng(bCoord, aCoord), new google.maps.LatLng(dCoord, cCoord));
  ...
  var opts = {
    ...
    center: new google.maps.LatLng(bCoord + (dCoord - bCoord) / 2, aCoord + (cCoord - aCoord) / 2),
    zoom: maxzoom
  };
